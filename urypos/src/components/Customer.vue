        ...
        <div class="mb-6 gap-6 md:grid-cols-2">
            <div class="relative mt-5 lg:mt-2" ref="container">
                ...
                <input type="search"
                    ...
                    placeholder="Search Customers" v-model="this.customers.search"
                    @input="this.customers.handleSearchInput" @click="this.customers.searchCustomer()
                        "
                    :disabled="this.menu.selectedOrderType === 'Aggregators' || this.recentOrders.previousOrderdCustomer !== ''"
                    required />
                <div v-if="this.customers.showCustomers && this.customers.showAddNewCustomer"
                    class="absolute left-0 top-full z-10 max-h-64 w-full overflow-y-scroll rounded bg-white shadow md:w-3/5 lg:w-2/5"
                    ref="dropdown">
                    <div class="h-16 rounded-lg p-4 hover:bg-gray-100"
                        v-for="(customer, index) in this.customers.customer" :key="index"
                    ...
                    <div v-if="this.customers.showAddNewCustomer">
                        <div class="flex justify-end">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="mt-2 mr-2 h-4 w-4" fill="none"
                        ...
                        <a href="#" class="mt-1 lg:mt-0 inline-flex items-center text-blue-600 hover:underline"
                            @click.prevent="
                        this.customers.newCustomerData(this.customers.search)
                        ">
                            <svg fill="none" stroke="currentColor" class="h-8 w-8 font-extrabold" viewBox="0 0 25 25"
            ...
            <div v-if="this.customers.showModalNewCustomer"
                    ...
                    <div class="w-full rounded-lg bg-white p-6 shadow-lg md:max-w-md">
                        <div class="flex justify-end">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24"
                                stroke="currentColor" @click="this.customers.showModalNewCustomer = false">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M6 18L18 6M6 6l12 12" />
                            </svg>
                        </div>
                        ...
                        <label for="newCustomer" class="mt-6 block text-left text-gray-900 dark:text-white">
                            Customer Name
                        </label>
                        ...
                        <label for="mobileNumber" class="mt-6 block text-left text-gray-900 dark:text-white">
                            Mobile Number
                        </label>
                        ...
                        <div class="relative mt-5" ref="container">
                            <label for="customerGroup" class="mt-6 block text-left text-gray-900 dark:text-white">
                                Customer Group
                            </label>
                            <input type="text" id="customerGroup"
                                class="mt-4 w-full rounded-lg border border-gray-300 bg-gray-50 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
                                v-model="this.customers.customerGroup" @click="
                        this.customers.showCustomersGroup = true;
                    this.customers.pickCustomerGroup();
                    " required />

                            <div v-if="this.customers.showCustomersGroup"
                                class="absolute left-0 top-full z-10 max-h-64 w-full overflow-y-scroll rounded bg-white shadow"
                                ref="dropdown">
                                <div class="h-12 rounded-lg p-4 hover:bg-gray-100"
                                    v-for="(group, index) in this.customers.customerGroupList" :key="index"
                        ...
                        <div class="relative mt-5" ref="container">
                            <label for="territory" class="mt-6 block text-left text-gray-900 dark:text-white">
                                Territory
                            </label>
                            <input type="text" id="territory"
                                class="mt-4 w-full rounded-lg border border-gray-300 bg-gray-50 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
                                v-model="this.customers.customerTerritory" @click="
                        this.customers.showCustomersTerritory = true;
                    this.customers.pickCustomerTerritory();
                    " required />

                            <div v-if="this.customers.showCustomersTerritory"
                                class="absolute left-0 top-full z-10 max-h-64 w-full overflow-y-scroll rounded bg-white shadow"
                                ref="dropdown">
                                <div class="h-12 rounded-lg p-4 hover:bg-gray-100" v-for="(territory, index) in this.customers
                        .customerTerritoryList" :key="index"
                        ...
                        <div class="flex justify-end">
                            <button @click="this.customers.addNewCustomer()"
            ...
            <div class="relative mb-4 mt-4" v-if="!this.auth.cashier">
                <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                    <svg class="h-6 w-6 text-gray-500 group-hover:text-blue-600 dark:text-gray-400 dark:group-hover:text-blue-500"
                        fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                        <path fill-rule="evenodd" d="M10 9a3 3 0 100-6 3 3 0 000 6zm-7 9a7 7 0 1114 0H3z"
                            clip-rule="evenodd"></path>
                    </svg>
                </div>
                <input type="number" id="numberOfPax"
                    class="block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 pl-10 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500 md:w-3/5 lg:w-2/5"
                    placeholder="Pax" required v-model="this.customers.numberOfPax"
                    @input="this.customers.validateInput" />
            </div>

            <div class="relative mt-5" ref="container" v-if="this.auth.cashier">
                <div class="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                    <svg class="h-6 w-6 text-gray-800 group-hover:text-blue-600 dark:text-gray-400 dark:group-hover:text-blue-500"
                ...
                <input type="text"
                    ...
                    :value="this.customers.selectedOrderType || this.recentOrders.pastOrderType" readonly required />
            </div>
            <h1 class="tex mt-5 text-lg font-medium" v-if="this.customers.customerFavouriteItems.length > 0">
                Favourite Items
            </h1>
            <div class="cart-item-details mt-1 grid grid-cols-2 gap-6 py-2 sm:w-full md:w-full lg:w-full lg:grid-cols-4"
            ...
            <div v-for="(item, index) in this.customers.customerFavouriteItems" :key="index">
                <div
